import pandas as pd
from sklearn.model_selection import train_test_split # pega as variáveis e separa entre treino e teste
...
def main():
    ...
    # Para cada elemento da base de teste será comparado com os elementos de treino
